...
def parse_arguments():
    ...
    parser.add_argument('--draft_model_1', type=str, default="phi-1")
    parser.add_argument('--target_model', type=str, default="phi-2")
    parser.add_argument('--draft_model_2', type=str, default=None)
    parser.add_argument('--draft_model_3', type=str, default=None)
    
    parser.add_argument('--exp_name', '-e', type=str, default="test", help='folder name for storing results.')
    parser.add_argument('--eval_mode', type=str, default="para_sd", choices=["small", "large", "sd", "para_sd", "para_sd_wo_1", "para_sd_wo_2"], help='eval mode.')
    parser.add_argument('--num_samples_per_task', '-n', type=int, default=1, help='num_samples for a task (prompt) in humaneval dataset.',max=3)
    ...
    parser.add_argument('--gamma', type=int, default=5, help='guess time.')
    parser.add_argument('--batch_size', type=int, default=1, help='batch size for generating new tokens.')
